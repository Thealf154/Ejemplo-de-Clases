...
public class Buho extends Aves {
    ...
    Buho(String sistemaDigestivo, String tiempoDeVida, String tipodevuelo, boolean vuela, String plumaje,
            boolean ulular, boolean giracabeza) {
    ...
    public static void main(String[] args) {
        System.out.println("Mostrando al buho");
